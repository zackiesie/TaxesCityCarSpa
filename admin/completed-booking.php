...
if($ptype==1): echo "BASIC WASH (RM30.00)";endif;
if($ptype==2): echo "PREMIUM (RM65.00)";endif;
if($ptype==3): echo "DETAILING (RM350.00)";endif;
if($ptype==4): echo "INTERIOR CLEANING (RM350.00)";endif;
if($ptype==5): echo "WATERMARK CLEANING (RM180.00)";endif;
if($ptype==6): echo "NANO MIST (RM65.00)";endif;
