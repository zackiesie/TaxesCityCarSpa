                ...
                <div class="row">
                    ...
                    <div class="price-item featured-item">
                            <div class="price-header">
                                <h3>Basic Wash</h3>
                                <h2><span>RM</span><strong>30</strong><span>.00</span></h2>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="price-item featured-item">
                            <div class="price-header">
                                <h3>Premium</h3>
                                <h2><span>RM</span><strong>65</strong><span>.00</span></h2>
                            </div>
                            <div class="price-body">
                            </div>
                            <div class="price-footer">
                    ...
                    <div class="price-item featured-item">
                            <div class="price-header">
                                <h3>Detailing</h3>
                                <h2><span>RM</span><strong>350</strong><span>.00</span></h2>
                            </div>
                            <div class="price-body">
                            </div>
                            <div class="price-footer">
...
<form method="post">   
  <p>
            <select name="packagetype" required class="form-control">
                ...
                <option value="1">BASIC WASH (RM30.00)</option>
                 <option value="2">PREMIUM (RM65.00)</option>
                  <option value="3 ">DETAILING (RM350.00)</option>
                  <option value="4 ">INTERIOR CLEANING (RM350.00)</option>
                  <option value="5 ">WATERMARK CLEANING (RM180.00)</option>
                  <option value="6 ">NANO MIST (RM65.00)</option>
